...
<body>
            ...
            <tr>
                ...
                <td style="width: 30%; border-bottom: solid 1px black; padding: 0 0 10px 0; vertical-align: text-top;">
                    <table style="width: 100%; border-collapse: collapse;">
                        <tr>
                            <td style="font-size: 12px; width: 45%; font-weight: 700;">Sale Order No</td>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 12px;">:</td>
                            <td style="font-size: 12px;">{{ $terms->name ?? null }}</td>
                        </tr>
                        <tr>
    ...
    <main>
        <table style="width: 100%; font-family: sans-serif; border-collapse: collapse; padding: 0 0 25px 0;">
            ...
            <tr>
                <td style="font-size: 12px; padding: 25px 0 0 0;">Thank you for your inquiry. We are pleased to submit
                    our
                    quote as follows:</td>
                <td style="font-size: 12px; padding: 25px 0 0 0;">Store:</td>
            </tr>
        </table>
        ...
        <table style="width: 100%; font-family: sans-serif; border-collapse: collapse;">
            <tr>
                ...
                <td
                    ...
                    UOM</td>
                <td
                    style="font-size: 10px; border-top: solid 1px black; border-bottom: solid 1px black; text-align: right; width: 15%;">
                    U/Price (RM)</td>
                <td
                    style="font-size: 10px; border-top: solid 1px black; border-bottom: solid 1px black; text-align: right; width: 15%;">
                    Discount (RM)</td>
                <td
                    style="font-size: 10px; border-top: solid 1px black; border-bottom: solid 1px black; text-align: right; width: 20%;">
                    Promotion (RM)</td>
                <td
                    style="font-size: 10px; border-top: solid 1px black; border-bottom: solid 1px black; text-align: right; width: 20%;">
                    Total (RM)</td>
        ...
        <table style="width: 100%; font-family: sans-serif; border-collapse: collapse;">
            <tr>
                <td style="font-size: 12px; padding: 25px 0 0px 0;" colspan="3">Note</td>
            </tr>
            <tr>
                <td style="font-size: 12px; padding: 0 0 40px 0;" colspan="3">
