            ...
            columnDefs: [{
                    ...
                    render: function(data, type, row) {
                        let convertable = row.conditions_to_convert.is_draft == false && row
                            .conditions_to_convert.payment_method_filled == false && row
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `<div class="flex flex-wrap w-32 items-center justify-end gap-2 px-2">
                            ...
                            ${
                                row.can_cancel ?
                                `<button class="rounded-full p-2 bg-violet-200 inline-block cancel-btns" data-id="${row.id}" title="{!! __('Void') !!}">
