<div class="bg-white p-4 border rounded-md">
    <div class="flex justify-between">
        ...
        <div class="hidden" id="by-pass-conversion-hint">
    ...
    <div class="grid grid-cols-3 gap-8 w-full mb-8">
        ...
        <div class="flex flex-col">
            ...
            <x-app.input.input name="by_pass_conversion" id="by_pass_conversion" :hasError="$errors->has('by_pass_conversion')" type="password" />
            <p class="text-xs mt-1 text-slate-400">{{ __('Enter your login password') }}</p>
            <x-app.message.error id="by_pass_conversion_err"/>
        </div>
        @endcan
        <div class="flex flex-col">
        ...
        <div class="flex flex-col">
            ...
            <div id="payment-amount-records-container" class="hidden">
                <span class="font-semibold mb-1 mt-1 text-xs inline-flex">{{ __('Records') }}</span>
