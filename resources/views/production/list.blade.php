                    ...
                    render: function(data, type, row) {
                        ...
                        return `<div class="flex flex-wrap w-32 items-center justify-end gap-2 px-2">
                            ${
                                ...
                                `
                                    ${
                                        row.can_edit_customize_product ? `
                                            <a href="{{ config('app.url') }}/customize/edit/${row.customize_product_id}" class="rounded-full p-2 bg-orange-200 inline-block" title="{!! __('Edit Customize Product') !!}">
