...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        <x-app.page-title>Customers</x-app.page-title>
        <a href="{{ route('customer.create') }}" class="bg-yellow-400 text-white shadow rounded-md py-2 px-4 flex items-center gap-x-2">
