        ...
        var dt = new DataTable('#data-table', {
            ...
            ajax: {
                data: function() {
                    ...
                    url =
                        `${url}?page=${ info.page + 1 }&debt_type=${ TABLE_FILTER['debt_type'] }&company_group=${ TABLE_FILTER['company_group'] }&category=${ TABLE_FILTER['category'] }&sales_agent=${ TABLE_FILTER['sales_agent'] }`
