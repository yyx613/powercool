<div class="bg-white p-4 border rounded-md">
    <div class="flex items-center mb-6 border-l-8 border-yellow-400 px-3 py-1 bg-yellow-50 w-fit">
        ...
        <span class="text-lg ml-3 font-bold">Locations</span>
    </div>
        ...
        <div>
            <div class="grid grid-cols-4 gap-8 w-full mb-8 p-4 rounded-md relative hidden group transition durtion-300 hover:bg-slate-50" id="item-template">
                ...
                <div class="flex col-span-4 hidden default-billing-msg">
                    <p class="text-xs text-blue-700 border border-blue-700 p-1.5 rounded shadow">Default Billing Address</p>
                </div>
                <div class="flex col-span-4 hidden default-delivery-msg">
                    <p class="text-xs text-blue-700 border border-blue-700 p-1.5 rounded shadow">Default Delivery Address</p>
                </div>
                ...
                <div class="flex flex-col">
                    <x-app.input.label id="city" class="mb-1">City <span class="text-sm text-red-500">*</span></x-app.input.label>
                ...
                <div class="flex flex-col">
                    <x-app.input.label id="state" class="mb-1">State <span class="text-sm text-red-500">*</span></x-app.input.label>
                ...
                <div class="flex flex-col">
                    <x-app.input.label id="zip_code" class="mb-1">Zip Code <span class="text-sm text-red-500">*</span></x-app.input.label>
                ...
                <div class="flex flex-col">
                    <x-app.input.label id="type" class="mb-1">Type <span class="text-sm text-red-500">*</span></x-app.input.label>
                ...
                <div class="flex flex-col">
                    <x-app.input.label id="is_default" class="mb-1">Is Default <span class="text-sm text-red-500">*</span></x-app.input.label>
