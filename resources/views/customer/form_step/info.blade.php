<form action="" method="POST" enctype="multipart/form-data" id="info-form" class="flex flex-col gap-8">
    ...
    <div class="bg-white p-4 border rounded-md">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 w-full mb-4">
            ...
            <div class="flex flex-col hidden non-individual-fields-container">
                ...
                <x-app.input.input name="tourism_tax_reg_no" id="tourism_tax_reg_no" :hasError="$errors->has('tourism_tax_reg_no')" value="{{ old('tourism_tax_reg_no', isset($customer) ? $customer->tourism_tax_reg_no: null) }}"/>
            ...
            <div class="flex flex-col hidden non-individual-fields-container">
                ...
                <x-app.input.input name="prev_gst_reg_no" id="prev_gst_reg_no" :hasError="$errors->has('prev_gst_reg_no')" value="{{ old('prev_gst_reg_no', isset($customer) ? $customer->prev_gst_reg_no : null) }}"/>
            ...
            <div class="flex flex-col hidden individual-fields-container"">
                ...
                <x-app.input.input name="identity_type" id="identity_type" :hasError="$errors->has('identity_type')" value="{{ old('identity_type', isset($customer) ? $customer->identity_type : null) }}"/>
    ...
    <div class="bg-white p-4 border rounded-md">
        <div class="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 w-full mb-4">
            ...
            @endif
            <div class="flex flex-col">
                <x-app.input.label id="type" class="mb-1">{{ __('Category') }}</x-app.input.label>
