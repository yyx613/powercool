...
@section('content')
    <div class="mb-6">
        <x-app.page-title>Convert Delivery Order to Invoice</x-app.page-title>
    </div>
    <div class="bg-white p-4 border rounded-md flex gap-x-14">
        ...
        <div class="flex-[3]">
                        ...
                        <ul>
                            @foreach ($terms as $term)
                                <li class="mb-4 rounded-md cursor-pointer transition duration-300 border border-slate-100 hover:border-black">
                                    <a href="{{ route('delivery_order.to_invoice') }}?term={{ $term }}" class="text-sm flex items-center justify-between p-2 font-semibold">
            ...
            @if ($step == 3)
                <div>
                    <div class="mb-4">
                        <h5 class="text-md font-semibold">Select delivery order to convert</h5> 
                    </div>
                    @if (count($delivery_orders) > 0)
                        ...
                        <div class="flex justify-end mt-8">
                            <a href="{{ route('delivery_order.convert_to_invoice') }}" class="w-1/6 bg-slate-100 rounded-md py-2 px-4 flex justify-center items-center gap-x-2" id="convert-btn">
