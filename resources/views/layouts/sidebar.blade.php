                ...
                <li>
                    <a href="{{ route('approval.index') }}"
                        ...
                        <div class="relative">
                            ...
                            <span
                                class="absolute flex h-2 w-2 top-0 right-0 {{ hasUnreadApprovals() ? '' : 'hidden' }}">
                                <span
                                    class="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                                <span class="relative inline-flex rounded-full h-2 w-2 bg-red-500"></span>
                            </span>
                                ...
                                @can('inventory.product.view')
                                    <li>
                                        <a href="{{ route('product.index') }}"
                                            ...
                                            <span
                                                class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Product') }}</span>
                                        </a>
                                    </li>
                                @endcan
                                    ...
                                    @can('production_material.view')
                                        <li>
                                            <a href="{{ route('production_material.index') }}"
                                                ...
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Material') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                </ul>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ route('sync.index') }}"
                                            class="rounded-md p-2 flex items-center {{ !str_contains(Route::currentRouteName(), 'sync.') && str_contains(Route::currentRouteName(), 'service.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                            <span
                ...
                @can('inventory.product.view')
                    <li>
                        <a href="{{ route('product.index') }}"
                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'product.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                            <span
                                class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Product') }}</span>
                        </a>
                    </li>
                @endcan
                @can('inventory.raw_material.view')
                ...
                @can('production_material.view')
                    <li>
                        <a href="{{ route('production_material.index') }}"
                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'production_material.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                            <span
                                class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Material') }}</span>
                        </a>
                    </li>
                @endcan
            </ul>
            ...
            <ul>
                ...
                <li>
                    <a href="{{ route('notification.index') }}"
                        ...
                        <span
                            class="block text-base ml-4 flex-1 whitespace-nowrap text-left leading-tight text-white">Notification</span>
                    </a>
                </li>
                <!-- Approval-->
                <li>
        ...
        $(document).ready(function() {
            ...
            if ($(window).width() >= 1024) {
                if (IS_SIDEBAR_EXPAND == 'true' || IS_SIDEBAR_EXPAND == null) {
                    if (CURRENT_ROUTE_NAME.includes('vehicle_service.') || CURRENT_ROUTE_NAME.includes(
                            'vehicle.')) {
                        ...
                        $('#expanded-sidebar .sidebar-menu-trigger[data-accordionstriggerid="101"]').click()
                            ...
                            'pending_order.') || CURRENT_ROUTE_NAME.includes('sale_order.') || CURRENT_ROUTE_NAME
                ...
                if (CURRENT_ROUTE_NAME.includes('vehicle_service.') || CURRENT_ROUTE_NAME.includes('vehicle.')) {
                    ...
                    CURRENT_ROUTE_NAME.includes('material_use.') || CCURRENT_ROUTE_NAME.includes(
