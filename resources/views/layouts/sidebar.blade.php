<!-- Expand -->
<aside class="max-w-[250px] w-full bg-blue-900 transition-all duration-700 delay-700 hidden lg:block"
    id="expanded-sidebar">
    <div class="h-screen flex flex-col sticky top-0 overflow-x-hidden">
        <div class="px-4 pt-4 pb-2 flex items-center">
            <button type="button" id="collapse-sidebar-btn">
                <svg class="h-5 w-5 fill-white" xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24"
        ...
        <div class="flex-1 overflow-y-auto px-2 my-4 hide-scrollbar">
            <ul>
                ...
                @can('notification.view')
                    <li>
                        <a href="{{ route('notification.index') }}"
                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'notification.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                            <div class="relative">
                                <svg class="h-5 w-5 flex-none fill-white" xmlns="http://www.w3.org/2000/svg" id="Outline"
                                ...
                                <span
                                    class="absolute flex h-2 w-2 top-0 right-0 {{ hasUnreadNotifications() ? '' : 'hidden' }}">
                                    <span
                            ...
                            <span
                                class="block text-base ml-4 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Notification') }}</span>
                        </a>
                    </li>
                @endcan
                <!-- Approval -->
                @can('approval.view')
                    <li>
                        <a href="{{ route('approval.index') }}"
                            class="p-2 flex items-center rounded-md {{ str_contains(Route::currentRouteName(), 'approval.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                            <div class="relative">
                                <svg class="h-5 w-5 flex-none fill-white" xmlns="http://www.w3.org/2000/svg" id="Layer_1"
                                ...
                                <span
                                    class="absolute flex h-2 w-2 top-0 right-0 {{ hasUnreadApprovals() ? '' : 'hidden' }} approval-red-dots">
                                    <span
                                        class="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                                    <span class="relative inline-flex rounded-full h-2 w-2 bg-red-500"></span>
                                </span>
                            ...
                            <span
                                class="block text-base ml-4 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Approval') }}</span>
                        </a>
                    </li>
                @endcan
                <!-- Dashboard -->
                    ...
                    <li>
                        <div class="transition-all duration-500 delay-75 cursor-pointer flex items-center justify-between sidebar-menu-trigger"
                            ...
                            <button class="p-2 flex items-center rounded-md w-full">
                                ...
                                <span
                                    class="block text-base ml-4 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Contact') }}</span>
                            </button>
                        </div>
                        <div class="grid grid-rows-[0fr] opacity-0 transition-all duration-500 sidebar-accordions"
                            data-accordionid="6">
                                    ...
                                    @can('customer.view')
                                        <li>
                                            <a href="{{ route('customer.index') }}"
                                                class="p-2 flex items-center rounded-md {{ str_contains(Route::currentRouteName(), 'customer.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Debtor') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('supplier.view')
                                        <li>
                                            <a href="{{ route('supplier.index') }}"
                                                class="p-2 flex items-center rounded-md {{ str_contains(Route::currentRouteName(), 'supplier.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Supplier') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('dealer.view')
                ...
                @can('vehicle.view')
                    <li>
                        <div class="transition-all duration-500 delay-75 cursor-pointer flex items-center justify-between sidebar-menu-trigger"
                            data-accordionstriggerid="11">
                            <button class="p-2 flex items-center rounded-md w-full">
                                <svg class="h-5 w-5 flex-none fill-white" xmlns="http://www.w3.org/2000/svg" id="Layer_1"
                                    data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512">
                                    <path
                                        d="M24,13a3,3,0,0,0-3-3h-.478L15.84,3.285A3,3,0,0,0,13.379,2h-7A3.016,3.016,0,0,0,3.575,3.937l-2.6,6.848A2.994,2.994,0,0,0,0,13v5H2v.5a3.5,3.5,0,0,0,7,0V18h6v.5a3.5,3.5,0,0,0,7,0V18h2ZM14.2,4.428,18.084,10H11V4h2.379A1,1,0,0,1,14.2,4.428Zm-8.753.217A1,1,0,0,1,6.381,4H9v6H3.416ZM7,18.5a1.5,1.5,0,0,1-3,0V18H7Zm13,0a1.5,1.5,0,0,1-3,0V18h3ZM22,16H2V13a1,1,0,0,1,1-1H21a1,1,0,0,1,1,1Z" />
                                </svg>
                                <span
                                    class="block text-base ml-4 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Vehicle') }}</span>
                            </button>
                        </div>
                        <div class="grid grid-rows-[0fr] opacity-0 transition-all duration-500 sidebar-accordions"
                            data-accordionid="11">
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ route('vehicle.index') }}"
                                            class="p-2 flex items-center rounded-md {{ str_contains(Route::currentRouteName(), 'vehicle.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                            <span
                                                class="block text-sm ml-9 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Vehicle') }}</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('vehicle_service.index') }}"
                                            class="p-2 flex items-center rounded-md {{ str_contains(Route::currentRouteName(), 'vehicle_service.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                            <span
                                                class="block text-sm ml-9 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Vehicle Service') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                ...
                @can('sale_enquiry.view')
                    <li>
                        <a href="{{ route('sale_enquiry.index') }}"
                            class="p-2 flex items-center rounded-md {{ str_contains(Route::currentRouteName(), 'sale_enquiry.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                            ...
                            <span
                                class="block text-base ml-4 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Sale Enquiry') }}</span>
                        </a>
                    </li>
                @endcan
                <!-- Sale & Invoice -->
                @canany(['sale.quotation.view', 'sale.sale_order.view', 'sale.cash_sale.view',
                    ...
                    <li>
                        <div class="transition-all duration-500 delay-75 cursor-pointer flex items-center justify-between sidebar-menu-trigger"
                            ...
                            <button class="p-2 flex items-center rounded-md w-full">
                                <svg class="h-5 w-5 flex-none fill-white" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <span
                                    class="block text-base ml-4 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Sale & Invoice') }}</span>
                            </button>
                        </div>
                        <div class="grid grid-rows-[0fr] opacity-0 transition-all duration-500 sidebar-accordions"
                            data-accordionid="3">
                            <div class="overflow-hidden">
                                <ul>
                                    @can('sale.quotation.view')
                                        <li>
                                            <a href="{{ route('quotation.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'quotation.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Quotation') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('e_order.view')
                                        <li>
                                            <a href="{{ route('pending_order.index') }}"
                                                ...
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('E-Order Assign') }}</span>
                                                <svg id="pending-orders-icon" xmlns="http://www.w3.org/2000/svg"
                                                    width="16" height="16" fill="#ee6b6e"
                                                    class="bi bi-exclamation-circle-fill ml-2" viewBox="0 0 16 16">
                                                    <path
                                    ...
                                    @can('sale.sale_order.view')
                                        <li>
                                            <a href="{{ route('sale_order.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'sale_order.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Sale Order') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('sale.cash_sale.view')
                                        <li>
                                            <a href="{{ route('cash_sale.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'cash_sale.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Cash Sale') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('sale.delivery_order.view')
                                        <li>
                                            <a href="{{ route('delivery_order.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'delivery_order.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Delivery Order') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('sale.transport_acknowledgement.view')
                                        <li>
                                            <a href="{{ route('transport_ack.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'transport_ack.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Transport Acknowledgement') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('sale.invoice.view')
                                        <li>
                                            <a href="{{ route('invoice.index') }}"
                                                class="rounded-md p-2 flex items-center {{ Route::currentRouteName() == 'invoice.index' ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Invoice') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('sale.invoice_return.view')
                                        <li>
                                            <a href="{{ route('invoice_return.index') }}"
                                                class="rounded-md p-2 flex items-center {{ Route::currentRouteName() == 'invoice_return.index' ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Invoice Return') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('sale.billing.view')
                                        <li>
                                            <a href="{{ route('billing.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'billing.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Billing') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                </ul>
                    ...
                    <li>
                        <div class="transition-all duration-500 delay-75 cursor-pointer flex items-center justify-between sidebar-menu-trigger"
                            ...
                            <button class="p-2 flex items-center rounded-md w-full">
                                ...
                                <span
                                    class="block text-base ml-4 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('E - Invoice') }}</span>
                            </button>
                        </div>
                        <div class="grid grid-rows-[0fr] opacity-0 transition-all duration-500 sidebar-accordions"
                                    ...
                                    @can('sale.draft_e_invoice.view')
                                        <li>
                                            <a href="{{ route('invoice.draft-e-invoice.index') }}"
                                                ...
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Submit to Approval') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('sale.e_invoice.view')
                                        <li>
                                            <a href="{{ route('invoice.e-invoice.index') }}"
                                                ...
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('E Invoice') }}</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('invoice.consolidated-e-invoice.index') }}"
                                                class="rounded-md p-2 flex items-center {{ Route::currentRouteName() == 'invoice.consolidated-e-invoice.index' ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Consolidated E Invoice') }}</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('invoice.credit-note.index') }}"
                                                class="rounded-md p-2 flex items-center {{ Route::currentRouteName() == 'invoice.credit-note.index' ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Credit Note') }}</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('invoice.debit-note.index') }}"
                                                class="rounded-md p-2 flex items-center {{ Route::currentRouteName() == 'invoice.debit-note.index' ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Debit Note') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                </ul>
                    ...
                    <li>
                        <div class="transition-all duration-500 delay-75 cursor-pointer flex items-center justify-between sidebar-menu-trigger"
                            ...
                            <button class="p-2 flex items-center rounded-md w-full">
                                ...
                                <span
                                    class="block text-base ml-4 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Inventory') }}</span>
                            </button>
                        </div>
                        <div class="grid grid-rows-[0fr] opacity-0 transition-all duration-500 sidebar-accordions"
                            data-accordionid="4">
                            <div class="overflow-hidden">
                                <ul>
                                    @can('inventory.summary.view')
                                        <li>
                                            <a href="{{ route('inventory_summary.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'inventory_summary.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Summary') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('grn.view')
                                        <li>
                                            <a href="{{ route('grn.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'grn.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('GRN') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('inventory.product.view')
                                        <li>
                                            <a href="{{ route('product.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'product.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Finish Good') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                    ...
                    <li>
                        <div class="transition-all duration-500 delay-75 cursor-pointer flex items-center justify-between sidebar-menu-trigger"
                            ...
                            <button class="p-2 flex items-center rounded-md w-full">
                                ...
                                <span
                                    class="block text-base ml-4 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Production') }}</span>
                            </button>
                        </div>
                        <div class="grid grid-rows-[0fr] opacity-0 transition-all duration-500 sidebar-accordions"
                            data-accordionid="10">
                                    ...
                                    @can('production.view')
                                        <li>
                                            <a href="{{ route('production.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'production.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Task') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('production_material.view')
                                        <li>
                                            <a href="{{ route('production_finish_good.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'production_finish_good.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Finish Good') }}</span>
                                            </a>
                                        </li>
                    ...
                    <li>
                        <div class="transition-all duration-500 delay-75 cursor-pointer flex items-center justify-between sidebar-menu-trigger"
                            ...
                            <button class="p-2 flex items-center rounded-md w-full">
                                ...
                                <span
                                    class="block text-base ml-4 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Ticket & Task') }}</span>
                            </button>
                        </div>
                        <div class="grid grid-rows-[0fr] opacity-0 transition-all duration-500 sidebar-accordions"
                            data-accordionid="8">
                                    ...
                                    @can('ticket.view')
                                        <li>
                                            <a href="{{ route('ticket.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'ticket.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Ticket') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('task_sale.view')
                                        <li>
                                            <a href="{{ route('task.sale.index') }}"
                                                ...
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Sale') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                </ul>
                ...
                @endcan
                <!-- Sale Target -->
                @canany(['sale.target.view'])
                    <li>
                        <div class="transition-all duration-500 delay-75 cursor-pointer flex items-center justify-between sidebar-menu-trigger"
                            data-accordionstriggerid="12">
                            <button class="p-2 flex items-center rounded-md w-full">
                                <svg class="h-5 w-5 flex-none fill-white" xmlns="http://www.w3.org/2000/svg"
                                    id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="512"
                                    height="512">
                                ...
                                <span
                                    class="block text-base ml-4 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Sale Target') }}</span>
                            </button>
                        </div>
                        <div class="grid grid-rows-[0fr] opacity-0 transition-all duration-500 sidebar-accordions"
                            data-accordionid="12">
                            <div class="overflow-hidden">
                                <ul>
                                    <li>
                                        <a href="{{ route('sale_cancellation.index') }}"
                                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'sale_cancellation.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                            <span
                                                class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Sale Cancellation') }}</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('target.index') }}"
                                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'target.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                            <span
                                                class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Target') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="overflow-hidden">
                                <ul>
                                    @can('service_history.view')
                                        <li>
                                            <a href="{{ route('service_history.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'service_history.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Service History') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('service_reminder.view')
                                        <li>
                                            <a href="{{ route('service_reminder.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'service_reminder.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Service Reminder') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('warranty.view')
                                        <li>
                                            <a href="{{ route('warranty.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'warranty.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Warranty') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                </ul>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ route('report.stock_report.index') }}"
                                            ...
                                            <span
                                                class="block text-sm ml-9 flex-1 leading-tight text-white">{{ __('Stock Card Materials') }}</span>
                                        </a>
                                    </li>
                                    @endcan
                                    ...
                                    <li>
                                        <a href="{{ route('report.stock_card_report.index') }}"
                                            ...
                                            <span
                                                class="block text-sm ml-9 flex-1 leading-tight text-white">{{ __('Stock Card Finished Good') }}</span>
                                        </a>
                                    </li>
                                    @endcan
                                    @can('report.earning')
                    ...
                    <li>
                        <div class="transition-all duration-500 delay-75 cursor-pointer flex items-center justify-between sidebar-menu-trigger"
                            ...
                            <button class="p-2 flex items-center rounded-md w-full">
                                ...
                                <span
                                    class="block text-base ml-4 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('User Role Management') }}</span>
                            </button>
                        </div>
                        <div class="grid grid-rows-[0fr] opacity-0 transition-all duration-500 sidebar-accordions"
                            data-accordionid="9">
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ route('user_management.index') }}"
                                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'user_management.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                            <span
                                                class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('User Management') }}</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('role_management.index') }}"
                                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'role_management.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                            <span
                                                class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Role Management') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <li>
                        <div class="transition-all duration-500 delay-75 cursor-pointer flex items-center justify-between sidebar-menu-trigger"
                            ...
                            <button class="p-2 flex items-center rounded-md w-full">
                                ...
                                <span
                                    class="block text-base ml-4 flex-1 whitespace-nowrap text-left leading-tight text-white">{{ __('Setting') }}</span>
                            </button>
                        </div>
                        <div class="grid grid-rows-[0fr] opacity-0 transition-all duration-500 sidebar-accordions"
                            data-accordionid="2">
                                    ...
                                    @can('inventory.category.view')
                                        <li>
                                            <a href="{{ route('inventory_category.index') }}"
                                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'inventory_category.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                                <span
                                                    class="block text-sm ml-9 flex-1 leading-tight whitespace-nowrap text-white">{{ __('Product Category') }}</span>
                                            </a>
                                        </li>
                                    @endcan
        ...
        <div class="px-4 py-3 border-t border-gray-50 flex items-center justify-between">
            <div class="flex-1 flex flex-col overflow-hidden">
                <span class="text-sm font-light text-slate-300 leading-none whitespace-nowrap"
                    id="time-section"></span>
                <h3 class="text-base font-medium leading-tight truncate whitespace-nowrap text-white">
                    {{ Auth::user()->name }}</h3>
            </div>
...
<aside class="max-w-0 bg-blue-900 -z-10 opacity-0 transition-all duration-700 hidden lg:block" id="collapsed-sidebar">
    <div class="h-screen py-4 px-2 sticky top-0 z-50">
        <div class="relative flex flex-col h-full">
            ...
            <div class="flex-1 my-4 overflow-y-auto overflow-x-hidden hide-scrollbar">
                <ul>
                    <!-- Notification -->
                    @can('notification.view')
                        <li>
                        ...
                        <li class="expand-sub-menu-triggers" data-type="e-invoice">
                            <button class="p-2.5 flex items-center justify-center rounded-full hover:bg-blue-600">
                                <svg class="h-5 w-5 fill-white" xmlns="http://www.w3.org/2000/svg" width="20"
                                    height="20" fill="white" class="bi bi-receipt" viewBox="0 0 16 16">
                                    <path
                                        d="M1.92.506a.5.5 0 0 1 .434.14L3 1.293l.646-.647a.5.5 0 0 1 .708 0L5 1.293l.646-.647a.5.5 0 0 1 .708 0L7 1.293l.646-.647a.5.5 0 0 1 .708 0L9 1.293l.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .801.13l.5 1A.5.5 0 0 1 15 2v12a.5.5 0 0 1-.053.224l-.5 1a.5.5 0 0 1-.8.13L13 14.707l-.646.647a.5.5 0 0 1-.708 0L11 14.707l-.646.647a.5.5 0 0 1-.708 0L9 14.707l-.646.647a.5.5 0 0 1-.708 0L7 14.707l-.646.647a.5.5 0 0 1-.708 0L5 14.707l-.646.647a.5.5 0 0 1-.708 0L3 14.707l-.646.647a.5.5 0 0 1-.801-.13l-.5-1A.5.5 0 0 1 1 14V2a.5.5 0 0 1 .053-.224l.5-1a.5.5 0 0 1 .367-.27m.217 1.338L2 2.118v11.764l.137.274.51-.51a.5.5 0 0 1 .707 0l.646.647.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.509.509.137-.274V2.118l-.137-.274-.51.51a.5.5 0 0 1-.707 0L12 1.707l-.646.647a.5.5 0 0 1-.708 0L10 1.707l-.646.647a.5.5 0 0 1-.708 0L8 1.707l-.646.647a.5.5 0 0 1-.708 0L6 1.707l-.646.647a.5.5 0 0 1-.708 0L4 1.707l-.646.647a.5.5 0 0 1-.708 0z" />
                                    <path
                                        d="M3 4.5a.5.5 0 0 1 .5-.5h6a.5.5 0 1 1 0 1h-6a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 1 1 0 1h-6a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 1 1 0 1h-6a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5m8-6a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5" />
                    ...
                    @endcan
                    <!-- Inventory -->
                    @canany(['inventory.summary.view', 'grn.view', 'inventory.product.view',
                    ...
                    <!-- Sale Target -->
                    @canany(['sale.target.view'])
                        <li class="expand-sub-menu-triggers" data-type="sale-target">
                            <button class="p-2.5 flex items-center justify-center rounded-full hover:bg-blue-600">
                                <svg class="h-5 w-5 fill-white" xmlns="http://www.w3.org/2000/svg" id="Layer_1"
                                    data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512">
                                    <path
            ...
            <div class="absolute top-0 left-14 shadow-[10px_0px_15px_#00000010] bg-blue-900 h-full py-4 px-2 border-l opacity-0 -z-50 invisible transition-all duration-300 max-w-0 min-w-[200px] sub-menu-content"
                ...
                <ul>
                    @can('customer.view')
                        <li>
                            <a href="{{ route('customer.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'customer.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Debtor') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('supplier.view')
                        <li>
                            <a href="{{ route('supplier.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'supplier.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Supplier') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('dealer.view')
                        <li>
                            <a href="{{ route('dealer.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'dealer.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Dealer') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('agent_debtor.view')
        ...
        @can('vehicle.view')
            <div class="absolute top-0 left-14 shadow-[10px_0px_15px_#00000010] bg-blue-900 h-full py-4 px-2 border-l opacity-0 -z-50 invisible transition-all duration-300 max-w-0 min-w-[200px] sub-menu-content"
                ...
                <ul>
                    <li>
                        <a href="{{ route('vehicle.index') }}"
                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'vehicle.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                            <span
                                class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Vehicle') }}</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('vehicle_service.index') }}"
                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'vehicle_service.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                            <span
                    ...
                    @can('inventory.summary.view')
                        <li>
                            <a href="{{ route('inventory_summary.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'inventory_summary.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Summary') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('grn.view')
                        <li>
                            <a href="{{ route('grn.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'grn.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('GRN') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('inventory.product.view')
                        <li>
                            <a href="{{ route('product.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'product.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Finish Good') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('inventory.raw_material.view')
                    ...
                    @can('production.view')
                        <li>
                            <a href="{{ route('production.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'production.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Task') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('production_material.view')
            ...
            <div class="absolute top-0 left-14 shadow-[10px_0px_15px_#00000010] bg-blue-900 h-full py-4 px-2 border-l opacity-0 -z-50 invisible transition-all duration-300 max-w-0 min-w-[200px] sub-menu-content"
                ...
                <ul>
                    @can('sale.quotation.view')
                        <li>
                            <a href="{{ route('quotation.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'quotation.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Quotation') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('e_order.view')
                        <li>
                            <a href="{{ route('pending_order.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'pending_order.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('E-Order Assign') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('sale.sale_order.view')
                        <li>
                            <a href="{{ route('sale_order.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'sale_order.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Sale Order') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('sale.cash_sale.view')
                        <li>
                            <a href="{{ route('cash_sale.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'cash_sale.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Cash Sale') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('sale.delivery_order.view')
                        <li>
                            <a href="{{ route('delivery_order.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'delivery_order.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Delivery Order') }}</span>
                            </a>
                        </li>
                        @can('sale.transport_acknowledgement.view')
                            <li>
                                <a href="{{ route('transport_ack.index') }}"
                                    class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'transport_ack.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                    <span
                                        class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Transport Acknowledgement') }}</span>
                                </a>
                            </li>
                        @endcan
                    @endcan
                    @can('sale.invoice.view')
                        <li>
                            <a href="{{ route('invoice.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'invoice.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Invoice') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('sale.invoice_return.view')
                        <li>
                            <a href="{{ route('invoice_return.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'invoice_return.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Invoice Return') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('sale.billing.view')
                        <li>
                            <a href="{{ route('billing.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'billing.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Billing') }}</span>
                            </a>
                        </li>
                    @endcan
                </ul>
                    ...
                    @can('sale.draft_e_invoice.view')
                        <li>
                            <a href="{{ route('invoice.draft-e-invoice.index') }}"
                                ...
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Submit to Approval') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('sale.e_invoice.view')
                        <li>
                            <a href="{{ route('invoice.e-invoice.index') }}"
                                ...
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('E Invoice') }}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('invoice.consolidated-e-invoice.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'invoice.consolidated-e-invoice.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Consolidated E Invoice') }}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('invoice.credit-note.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'invoice.credit-note.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Credit Note') }}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('invoice.debit-note.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'invoice.debit-note.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Debit Note') }}</span>
                            </a>
                        </li>
                    @endcan
                </ul>
                    ...
                    @can('ticket.view')
                        <li>
                            <a href="{{ route('ticket.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'ticket.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Ticket') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('task_driver.view')
        ...
        @canany(['sale.target.view'])
            <div class="absolute top-0 left-14 shadow-[10px_0px_15px_#00000010] bg-blue-900 h-full py-4 px-2 border-l opacity-0 -z-50 invisible transition-all duration-300 max-w-0 min-w-[200px] sub-menu-content"
                data-type="sale-target">
                <div class="mb-4 p-2 border-b">
                    <h6 class="text-lg font-semibold whitespace-nowrap text-white">{{ __('Sale Target') }}</h6>
                </div>
                <ul>
                    <li>
                        <a href="{{ route('sale_cancellation.index') }}"
                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'sale_cancellation.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                            <span
                                class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Sale Cancellation') }}</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('target.index') }}"
                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'target.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                            <span
                                class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Target') }}</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        @canany(['service_history.view', 'service_reminder.view', 'warranty.view'])
            <div class="absolute top-0 left-14 shadow-[10px_0px_15px_#00000010] bg-blue-900 h-full py-4 px-2 border-l opacity-0 -z-50 invisible transition-all duration-300 max-w-0 min-w-[200px] sub-menu-content"
                data-type="service-history-and-warranty">
                <div class="mb-4 p-2 border-b">
                    ...
                    @can('service_history.view')
                        <li>
                            <a href="{{ route('service_history.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'service_history.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Service History') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('service_reminder.view')
                        <li>
                            <a href="{{ route('service_reminder.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'service_reminder.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Service Reminder') }}</span>
                            </a>
                        </li>
                    @endcan
                    @can('warranty.view')
                        <li>
                            <a href="{{ route('warranty.index') }}"
                                class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'warranty.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                                <span
                                    class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Warranty') }}</span>
                            </a>
                        </li>
                    @endcan
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{ route('report.stock_report.index') }}"
                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'report.stock_report.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                            <span
                                class="block text-sm flex-1 leading-tight text-white">{{ __('Stock Card Materials') }}</span>
                        </a>
                    </li>
                    @endcan
                    @can('report.stock_card')
                    <li>
                        <a href="{{ route('report.stock_card_report.index') }}"
                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'report.stock_card_report.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                            <span
                                class="block text-sm flex-1 leading-tight text-white">{{ __('Stock Card Finished Good') }}</span>
                        </a>
                    </li>
                    @endcan
                    @can('report.earning')
        ...
        @can('user_role_management.view')
            <div class="absolute top-0 left-14 shadow-[10px_0px_15px_#00000010] bg-blue-900 h-full py-4 px-2 border-l opacity-0 -z-50 invisible transition-all duration-300 max-w-0 min-w-[200px] sub-menu-content"
                data-type="user-role-management">
                <div class="mb-4 p-2 border-b">
                ...
                <ul>
                    <li>
                        <a href="{{ route('user_management.index') }}"
                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'user_management.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                            <span
                                class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('User Management') }}</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('role_management.index') }}"
                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'role_management.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                            <span
                                class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Role Management') }}</span>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                @can('inventory.category.view')
                    <li>
                        <a href="{{ route('inventory_category.index') }}"
                            class="rounded-md p-2 flex items-center {{ str_contains(Route::currentRouteName(), 'inventory_category.') ? 'bg-blue-600' : 'hover:bg-blue-600' }}">
                            <span
                                class="block text-sm flex-1 leading-tight whitespace-nowrap text-white">{{ __('Product Category') }}</span>
                        </a>
                    </li>
                @endcan
                @can('setting.promotion.view')
        ...
        $(document).ready(function() {
            ...
            if ($(window).width() >= 1024) {
                if (IS_SIDEBAR_EXPAND == 'true' || IS_SIDEBAR_EXPAND == null) {
                    if (CURRENT_ROUTE_NAME.includes('sale_cancellation.') || CURRENT_ROUTE_NAME.includes(
                            'target.')) {
                        $('#expanded-sidebar .sidebar-menu-trigger[data-accordionstriggerid="12"]').click()
                    } else if (CURRENT_ROUTE_NAME.includes('vehicle_service.') || CURRENT_ROUTE_NAME.includes(
                            'vehicle.')) {
                    ...
                    } else if (CURRENT_ROUTE_NAME.includes('invoice.draft-e-invoice.') || CURRENT_ROUTE_NAME
                        .includes('invoice.e-invoice.') || CURRENT_ROUTE_NAME.includes(
                    ...
                    } else if (CURRENT_ROUTE_NAME.includes('quotation.') || CURRENT_ROUTE_NAME.includes(
                            'pending_order.') || CURRENT_ROUTE_NAME.includes('cash_sale.') || CURRENT_ROUTE_NAME
                        .includes('sale_order.') || CURRENT_ROUTE_NAME
                        .includes('delivery_order.') || CURRENT_ROUTE_NAME.includes('transport_ack.') ||
                        CURRENT_ROUTE_NAME.includes('invoice.') || CURRENT_ROUTE_NAME.includes('billing.') ||
                        ...
                        CURRENT_ROUTE_NAME.includes('task.technician.') ||
                        CURRENT_ROUTE_NAME.includes('task.sale.')) {
                        $('#expanded-sidebar .sidebar-menu-trigger[data-accordionstriggerid="8"]').click()
                            ...
                            'service_reminder.') || CURRENT_ROUTE_NAME.includes('warranty.')) {
                ...
                if (CURRENT_ROUTE_NAME.includes('sale_cancellation.') || CURRENT_ROUTE_NAME.includes('target.')) {
                    $('#expanded-sidebar .sidebar-menu-trigger[data-accordionstriggerid="12"]').click()
                } else if (CURRENT_ROUTE_NAME.includes('vehicle_service.') || CURRENT_ROUTE_NAME.includes(
                        'vehicle.')) {
                    $('#expanded-sidebar .sidebar-menu-trigger[data-accordionstriggerid="11"]').click()
                    ...
                    $('#expanded-sidebar .sidebar-menu-trigger[data-accordionstriggerid="6"]').click()
                } else if (CURRENT_ROUTE_NAME.includes('invoice.draft-e-invoice.') || CURRENT_ROUTE_NAME.includes(
                        'invoice.e-invoice.') || CURRENT_ROUTE_NAME.includes(
                    ...
                    CURRENT_ROUTE_NAME.includes('material_use.') || CURRENT_ROUTE_NAME.includes(
                        'milestone.') || CURRENT_ROUTE_NAME.includes('payment_method.') || CURRENT_ROUTE_NAME
                    .includes(
                        'inventory_type.') || CURRENT_ROUTE_NAME.includes('inventory_category.') ||
                    CURRENT_ROUTE_NAME
