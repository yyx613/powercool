                            ...
                            return  `<div class="flex items-center justify-end gap-x-2 px-2">
                                ${
                                    row.progress >= 100 || row.status == 3 ? `
                                        <button class="rounded-full py-2 px-3 bg-purple-200 flex items-center gap-x-2 stock-in-btns" data-id="${row.id}" data-serial-no="${row.sku}" data-order-id="${row.order_id.sku ?? row.order_id}">
