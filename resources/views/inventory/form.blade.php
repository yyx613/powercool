            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-8 w-full items-start">
                ...
                @if ($is_product == true)
                    <div class="flex flex-col hidden" id="hi_ten_stock_code-container">
                        <x-app.input.label id="hi_ten_stock_code" class="mb-1">{{ __('Power Cool stock code') }}</x-app.input.label>
                        <x-app.input.select2 name="hi_ten_stock_code" id="hi_ten_stock_code" :hasError="$errors->has('hi_ten_stock_code')" placeholder="{{ __('Select a Power Cool stock code') }}">
