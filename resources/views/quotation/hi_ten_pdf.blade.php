    ...
    <main>
            ...
            <thead>
                <tr>
                    ...
                    <td
                        ...
                        Qty</td>
                    <td
                        style="font-size: 12px; border-bottom: solid 1px black; padding: 0 4px 5px 5px; text-align: center; width: 5%;">
                        UOM</td>
                    <td
        ...
        <table style="width: 100%; font-family: sans-serif; border-collapse: collapse; padding: 0 0 15px 0;">
            ...
            <tr>
                ...
                <td style="font-size: 12px; width: 100%; text-align: left;">The warranty will be considered void if the refrigerator has been modified or its original specifications altered without prior authorization from the manufacturer.</td>
            </tr>
            <tr>
