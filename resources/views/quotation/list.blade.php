...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        <x-app.page-title>Quotation</x-app.page-title>
        <div class="flex gap-x-4">
            ...
            <a href="{{ route('quotation.create') }}" class="bg-yellow-400 shadow rounded-md py-2 px-4 flex items-center gap-x-2">
                ...
                { 
                    ...
                    render: function (data, type, row) {
                       return  `<div class="flex items-center justify-end gap-x-2 px-2">
                            <a href="{{ config('app.url') }}/quotation/pdf/${row.id}" class="rounded-full p-2 bg-yellow-200 inline-block" target="_blank">
                            ...
                            <a href="{{ config('app.url') }}/quotation/edit/${row.id}" class="rounded-full p-2 bg-blue-200 inline-block">
