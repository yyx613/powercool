...
<body>
    ...
    <table style="width: 100%; font-family: sans-serif; border-collapse: collapse; padding: 0 0 25px 0;">
        <tr>
            <td style="font-size: 18px; font-weight: 700; width: 65%; padding: 15px 35px 10px 0; text-align: center;" colspan="2">QUOTATION</td>
        </tr>
        <tr>
    ...
    <table style="width: 100%; font-family: sans-serif; border-collapse: collapse;">
        ...
        @foreach ($products as $key => $prod)
            <tr>
                ...
                <td style="font-size: 14px; text-align: center;">PCS</td>
    ...
    <table style="width: 100%; font-family: sans-serif; border-collapse: collapse;">
        <tr>
            ...
            <td style="font-size: 14px; font-weight: 700; text-align: right; padding: 10px 0 0 0; border-top: solid 1px black;">Sub Total (Excluding SST) {{ number_format($total, 2) }}</td>
        </tr>
        <tr>
            <td style="font-size: 14px; font-weight: 700;">Delivery Term</td>
            <td style="font-size: 14px; font-weight: 700;">:</td>
            <td style="font-size: 14px; font-weight: 700; text-align: right; padding: 10px 0 0 0;">Tax @ 0% on 0.00 {{ number_format(0, 2) }}</td>
        </tr>
        <tr>
            <td style="font-size: 14px; font-weight: 700;">Payment Term</td>
            <td style="font-size: 14px; font-weight: 700;">:</td>
            <td style="font-size: 14px; font-weight: 700; text-align: right; padding: 10px 0 0 0;">Total (Inclusive of SST) {{ number_format($total, 2) }}</td>
        </tr>
    </table>
