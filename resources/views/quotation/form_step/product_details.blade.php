<div class="bg-white p-4 border rounded-md" id="product-details-container">
    ...
    <!-- Template -->
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-8 w-full mb-8 p-4 rounded-md relative group hidden transition durtion-300 hover:bg-slate-50" id="item-template">
