...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        ...
        <a href="{{ route('service_history.create') }}" class="bg-yellow-400 shadow rounded-md py-2 px-4 flex items-center gap-x-2">
                ...
                { 
                    ...
                    render: function (data, type, row) {
                       return  `<div class="flex items-center justify-end gap-x-2 px-2">
                            <a href="{{ config('app.url') }}/service-history/view/${row.id}" class="rounded-full p-2 bg-green-200 inline-block" title="View History">
