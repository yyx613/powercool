        ...
        var dt = new DataTable('#data-table', {
            ...
            columnDefs: [
                ...
                { 
                    ...
                    'orderable': false,
                    render: function(data, type, row) {
                        return `${row.product.model_name} (${row.product.sku})`
                    }
                },
                { 
                    "targets": 2,
                ...
                { 
                    ...
                    render: function (data, type, row) {
                       return  `<div class="flex items-center justify-end gap-x-2 px-2">
                            <a href="{{ config('app.url') }}/warranty/view/${row.sale_order_id}" class="rounded-full p-2 bg-green-200 inline-block" title="View History">
