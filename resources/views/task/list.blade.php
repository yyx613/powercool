        ...
        var dt = new DataTable('#data-table', {
            ...
            ajax: {
                data: function(){
                    ...
                    if (FOR_ROLE == 'driver') {
                        var url = "{{ route('task.driver.get_data') }}"
                    } else if (FOR_ROLE == 'technician') {
                        var url = "{{ route('task.technician.get_data') }}"
                    } else if (FOR_ROLE == 'sale') {
                        var url = "{{ route('task.sale.get_data') }}"
                    }
