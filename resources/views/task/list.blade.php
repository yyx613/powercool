...
@section('content')
    ...
    <div>
        ...
        <div class="flex items-center gap-x-4 max-w-screen-sm w-full mb-4">
            ...
            <!-- Generate Report -->
            <div class="flex-1">
                <button type="button" class="flex items-center gap-x-4 bg-sky-300 p-2 rounded w-fit"
        ...
        var dt = new DataTable('#data-table', {
            ...
            ajax: {
                data: function() {
                    ...
                    url =
                        `${url}?page=${ INIT_LOAD == true && DEFAULT_PAGE != null ? DEFAULT_PAGE : info.page + 1 }&role=${ FOR_ROLE == 'driver' ? 'driver' : (FOR_ROLE == 'technician' ? 'technician' : 'sale') }`
