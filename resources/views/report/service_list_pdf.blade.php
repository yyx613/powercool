...
<body style="font-family: sans-serif;">
    ...
    <h1 style="font-size: 20px;">Service Report</h1>
    
    <table style="border: solid 1px grey; border-collapse: collapse; width: 100%;">
        <tr>
            <th style="text-align: left; font-size: 14px; border: solid 1px grey; padding: 5px;">Product</th>
            <th style="text-align: left; font-size: 14px; border: solid 1px grey; padding: 5px;">Service Done (Count)</th>
            <th style="text-align: left; font-size: 14px; border: solid 1px grey; padding: 5px;">Income Generated</th>
        </tr>
        @foreach($records as $record)
        <tr>
            <td style="font-size: 14px; border: solid 1px grey; padding: 5px;">{{ $record->product }}</td>
            <td style="font-size: 14px; border: solid 1px grey; padding: 5px;">{{ $record->service_count }}</td>
            <td style="font-size: 14px; border: solid 1px grey; padding: 5px;">RM {{ $record->income_generated }}</td>
        </tr>
        @endforeach
    </table>
