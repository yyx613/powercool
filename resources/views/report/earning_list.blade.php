...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        <x-app.page-title>{{ __('Earning Report') }}</x-app.page-title>
        <a href="{{ route('report.earning_report.export') }}" class="bg-green-200 shadow rounded-md py-2 px-4 flex items-center gap-x-2">
