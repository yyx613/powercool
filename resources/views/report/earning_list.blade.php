...
@section('content')
    <div class="mb-6 flex justify-between items-start md:items-center flex-col md:flex-row">
        <x-app.page-title class="mb-4 md:mb-0" description="{{ __('Analyze profit and earnings by product with sales vs cost breakdown') }}">{{ __('Earning Report') }}</x-app.page-title>
