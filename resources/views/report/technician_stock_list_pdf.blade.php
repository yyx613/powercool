...
<body style="font-family: sans-serif;">
    ...
    <h1 style="font-size: 20px;">Technician Stock Report</h1>
    
    <table style="border: solid 1px grey; border-collapse: collapse; width: 100%;">
        <tr>
            <th style="text-align: left; font-size: 14px; border: solid 1px grey; padding: 5px;">Technician</th>
            <th style="text-align: left; font-size: 14px; border: solid 1px grey; padding: 5px;">Task ID</th>
            <th style="text-align: left; font-size: 14px; border: solid 1px grey; padding: 5px;">Product For Replacement</th>
            <th style="text-align: left; font-size: 14px; border: solid 1px grey; padding: 5px;">Material Used Qty</th>
        </tr>
        @foreach($records as $record)
        <tr>
            <td style="font-size: 14px; border: solid 1px grey; padding: 5px;">{{ $record->technician }}</td>
            <td style="font-size: 14px; border: solid 1px grey; padding: 5px;">{{ $record->sku }}</td>
            <td style="font-size: 14px; border: solid 1px grey; padding: 5px;">{{ $record->product_for_replacement }}</td>
            <td style="font-size: 14px; border: solid 1px grey; padding: 5px;">{{ $record->material_used_qty }}</td>
        </tr>
        @endforeach
    </table>
