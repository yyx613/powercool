...
<body style="font-family: sans-serif;">
    ...
    <h1 style="font-size: 20px;">Earning Report</h1>
    ...
    <table style="border: solid 1px grey; border-collapse: collapse; width: 100%;">
        ...
        <tr>
            ...
            <td style="font-size: 14px; border: solid 1px grey; padding: 5px;">{{ number_format($record->sum_cost, 2) }}</td>
            <td style="font-size: 14px; border: solid 1px grey; padding: 5px;">{{ number_format($record->sum_amount - $record->sum_promo_amount - $record->sum_cost, 2) }}</td>
        </tr>
        @endforeach
    </table>
