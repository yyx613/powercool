...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        <x-app.page-title>Sales Report</x-app.page-title>
    ...
    <div>
        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex-1 flex flex-col items-end justify-end gap-x-4">
                <span id="overall-qty" class="text-sm">Overall Qty: 0</span>
                <span id="overall-amount" class="text-sm">Overall Amount: 0</span>
            </div>
        </div>
