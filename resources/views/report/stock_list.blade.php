@extends('layouts.app')
@section('title', 'Stock Card Materials')
...
@section('content')
    <div class="mb-6 flex justify-between items-start md:items-center flex-col md:flex-row">
        <x-app.page-title class="mb-4 md:mb-0" description="{{ __('Per-item stock movement ledger across locations with running balance') }}">{{ __('Stock Card Materials') }}</x-app.page-title>
