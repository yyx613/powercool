...
@section('content')
    <div class="mb-6 flex justify-between items-start md:items-center flex-col md:flex-row">
        <x-app.page-title class="mb-4 md:mb-0" description="{{ __('Review available, reserved, and on-hold stock levels by product') }}">{{ __('Stock Report') }}</x-app.page-title>
    ...
    <script>
        ...
        var dt = new DataTable('#data-table', {
            ...
            columns: [
                { data: 'product_name' },
                { data: 'product_code' },
                { data: 'warehouse_available_stock' },
                { data: 'warehouse_reserved_stock' },
                { data: 'warehouse_on_hold_stock' },
            ],
            columnDefs: [
                {
                    "width": "10%",
