                    ...
                    render: function (data, type, row) {
                        ...
                        return  `<div class="flex items-center justify-end gap-x-2 px-2">
                            ${row.status !== "Cancelled" && hoursDifference <= 72 ? `
                                <a href="#" class="rounded-full p-2 bg-green-200 inline-block" target="_blank" id="cancel_document" data-id="${row.uuid}">
                            ...
                            ${row.status == "Cancelled" ? `
                                <a href="#" class="rounded-full p-2 bg-green-200 inline-block" target="_blank" id="resubmit_document" data-id="${row.uuid}">
