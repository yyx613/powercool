    ...
    <table style="width: 100%; font-family: sans-serif; border-collapse: collapse;">
        ...
        @foreach ($products as $key => $prod)
            ...
            <tr>
                ...
                <td style="font-size: 14px; padding: 0 4px; text-align: left;">{{ $product->sku }}</td>
                <td style="font-size: 14px; padding: 0 4px; text-align: left;">{{ $product->model_desc }}</td>
                <td style="font-size: 14px; padding: 0 4px; text-align: right;">{{ $prod->qty }}</td>
                <td style="font-size: 14px; padding: 0 4px; text-align: right;">{{ $product->uom }}</td>
                <td style="font-size: 14px; padding: 0 4px; text-align: right;">
                    {{ number_format($prod->price, 2) }}
                </td>
                <td style="font-size: 14px; padding: 0 4px; text-align: right;">{{ number_format(0, 2) }}</td>
                <td style="font-size: 14px; padding: 0 4px; text-align: right;">{{ number_format($prod->qty * $prod->price, 2) }}</td>
            </tr>
            @php
