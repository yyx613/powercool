    ...
    <div class="table-header-fixed">
        <table style="width: 100%; font-family: sans-serif; border-collapse: collapse;">
            <tr>
                ...
                <td style="font-size: 14px; border-top: solid 1px black; border-bottom: solid 1px black; padding: 5px 4px; text-align: left; width: 10%;">Tax Code</td>
                <td style="font-size: 14px; border-top: solid 1px black; border-bottom: solid 1px black; padding: 5px 4px; text-align: left; width: 30%;">Description</td>
                <td style="font-size: 14px; border-top: solid 1px black; border-bottom: solid 1px black; padding: 5px 4px; text-align: right; width: 5%;">Qty</td>
                <td style="font-size: 14px; border-top: solid 1px black; border-bottom: solid 1px black; text-align: right; width: 5%; padding-left: 5px; padding-right: 4px;">UOM</td>
                <td style="font-size: 14px; border-top: solid 1px black; border-bottom: solid 1px black; text-align: right; width: 10%; padding-left: 5px; padding-right: 4px;">U/Price<br>(RM)</td>
                <td style="font-size: 14px; border-top: solid 1px black; border-bottom: solid 1px black; text-align: right; width: 10%; padding-left: 5px; padding-right: 4px;">Discount<br>(RM)</td>
                <td style="font-size: 14px; border-top: solid 1px black; border-bottom: solid 1px black; text-align: right; width: 10%; padding-left: 5px; padding-right: 4px;">Total<br>(RM)</td>
            </tr>
        </table>
    </div>
    @php
    ...
    <table style="width: 100%; font-family: sans-serif; border-collapse: collapse;">
        ...
        @foreach ($do_products as $key => $prod)
            <tr>
                ...
                <td style="font-size: 14px; padding: 0 4px; text-align: left;">{{ $prod->saleProduct->product->model_desc }}</td>
                <td style="font-size: 14px; padding: 0 4px; text-align: right;">1</td>
                <td style="font-size: 14px; text-align: right; padding-left: 5px; padding-right: 4px;">{{ $prod->saleProduct->product->uom }}</td>
                <td style="font-size: 14px; text-align: right; padding-left: 5px; padding-right: 4px;">{{ number_format($prod->saleProduct->unit_price, 2) }}</td>
                <td style="font-size: 14px; text-align: right; padding-left: 5px; padding-right: 4px;">{{ number_format($prod->saleProduct->discountAmount(), 2) }}</td>
                <td style="font-size: 14px; text-align: right; padding-left: 5px; padding-right: 4px;">{{ number_format($prod->saleProduct->unit_price - $prod->saleProduct->discountAmount(), 2) }}</td>
            </tr>
            @php
        ...
        @endforeach
        <!-- Self Collect -->
        @if (isset($sale) && $sale->self_collect)
            <tr>
                <td colspan="2"></td>
                <td style="font-size: 14px; padding: 15px 0 0 0; font-weight: 700;">SELF COLLECT</td>
                <td colspan="5"></td>
            </tr>
            @if ($sale->self_collect_branch && $sale->self_collect_branch != 'kl')
                <tr>
                    <td colspan="2"></td>
                    <td style="font-size: 14px; padding: 2px 0;">
            ...
            @elseif ($sale->self_collect_branch == 'kl' && $sale->delivery_address)
                <tr>
                    <td colspan="2"></td>
                    <td style="font-size: 14px; padding: 2px 0;">{{ $sale->delivery_address }}</td>
                    <td colspan="5"></td>
                </tr>
            @endif
        @endif
