...
<body id="body" class="t68" style="min-width:100%;Margin:0px;padding:0px;background-color:#FFFFFF;">
    <div class="t67" style="background-color:#FFFFFF;">
                        ...
                        <tr>
                            <td align="center">
                                <table class="t64" role="presentation" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <!--[if mso]>
<td width="600" class="t63" style="background-color:#FFFFFF;border:1px solid #EBEBEB;overflow:hidden;width:600px;border-radius:3px 3px 3px 3px;">
<![endif]-->
                                        <!--[if !mso]>-->
                                        <td class="t63"
                                            style="background-color:#FFFFFF;border:1px solid #EBEBEB;overflow:hidden;width:600px;border-radius:3px 3px 3px 3px;">
                                            <!--<![endif]-->
                                            <table class="t62" role="presentation" cellpadding="0" cellspacing="0"
                                                width="100%" style="width:100%;">
                                                <tr>
                                                    <td class="t61" style="padding:44px 42px 32px 42px;">
                                                                            ...
                                                                            <td class="t3" style="">
                                                                                ...
                                                                                <table class="t2"
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="t1">
                                                                                            <div style="display: flex; align-items: center; column-gap: 0.5rem; width: 30%;">
                                                                                                <img src="{{ asset('/images/image_1.png') }}" alt="Power Cool Logo" style="width: 50%; height: 50%;">
                                                                                                <h1 style="margin: 0; font-family: Montserrat, BlinkMacSystemFont, Segoe UI, Helvetica Neue, Arial, sans-serif; font-weight: 700; font-size: 24px; line-height: 100%; letter-spacing: 0; color: #141414;">
                                                                                                    {{ $company }}
                                                                                                </h1>
                                                                                            </div>
                                                                                        </td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="t18">
                                                                                            <p class="t17"
                                                                                                style="margin:0;Margin:0;font-family:Open Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:25px;font-weight:400;font-style:normal;font-size:15px;text-decoration:none;text-transform:none;letter-spacing:-0.1px;direction:ltr;color:#141414;text-align:left;mso-line-height-rule:exactly;mso-text-raise:3px;">
                                                                                                I hope this email
                                                                                                finds you well. Please
                                                                                                find attached the
                                                                                                {{ $type }} for your recent
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding-top: 15px;">
                                                                    <table class="t26" role="presentation"
                                                                        ...
                                                                        <tr>
                                                                            <!--[if mso]>
<td width="514" class="t25" style="width:514px;">
<![endif]-->
                                                                            <!--[if !mso]>-->
                                                                            <td class="t25" style="width:514px;">
                                                                                <!--<![endif]-->
                                                                                <table class="t24"
                                                                                    role="presentation"
                                                                                    cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <table class="t31" role="presentation"
                                                                        ...
                                                                        <tr>
                                                                            <!--[if mso]>
<td width="514" class="t30" style="width:514px;">
<![endif]-->
                                                                            <!--[if !mso]>-->
                                                                            <td class="t30" style="width:514px;">
                                                                                <!--<![endif]-->
                                                                                <table class="t29"
                                                                                    role="presentation"
                                                                                    cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <table class="t36" role="presentation"
                                                                        ...
                                                                        <tr>
                                                                            <!--[if mso]>
<td width="514" class="t35" style="width:514px;">
<![endif]-->
                                                                            <!--[if !mso]>-->
                                                                            <td class="t35" style="width:514px;">
                                                                                <!--<![endif]-->
                                                                                <table class="t34"
                                                                                    role="presentation"
                                                                                    cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <table class="t41" role="presentation"
                                                                        cellpadding="0" cellspacing="0"
                                                                        style="Margin-left:auto;Margin-right:auto;">
                                                                        <tr>
                                                                            <!--[if mso]>
<td width="514" class="t40" style="width:514px;">
<![endif]-->
                                                                            <!--[if !mso]>-->
                                                                            <td class="t40" style="width:514px;">
                                                                                <!--<![endif]-->
                                                                                <table class="t39"
                                                                                    role="presentation"
                                                                                    cellpadding="0" cellspacing="0"
                                                                                    ...
                                                                                    style="width:100%;">
                                                                                    <tr>
                                                                                        <td class="t38" style="padding-top:15px;">
                                                                                            <p class="t37"
                                                                                                style="margin:0;Margin:0;font-family:Open Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:25px;font-weight:400;font-style:normal;font-size:15px;text-decoration:none;text-transform:none;letter-spacing:-0.1px;direction:ltr;color:#141414;text-align:left;mso-line-height-rule:exactly;mso-text-raise:3px;">
                                                                                                Should you have any
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <table class="t46" role="presentation"
                                                                        cellpadding="0" cellspacing="0"
                                                                        style="Margin-left:auto;Margin-right:auto;">
                                                                        <tr>
                                                                            <!--[if mso]>
<td width="514" class="t45" style="width:514px;">
<![endif]-->
                                                                            <!--[if !mso]>-->
                                                                            <td class="t45" style="width:514px;">
                                                                                <!--<![endif]-->
                                                                                <table class="t44"
                                                                                    role="presentation"
                                                                                    cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <table class="t59" role="presentation"
                                                                        cellpadding="0" cellspacing="0"
                                                                        style="Margin-left:auto;Margin-right:auto;">
                                                                        <tr>
                                                                            <!--[if mso]>
<td width="514" class="t58" style="border-top:1px solid #DFE1E4;width:514px;">
<![endif]-->
                                                                            <!--[if !mso]>-->
                                                                            <td class="t58"
                                                                                                                ...
                                                                                                                <table
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td class="t48"
                                                                                                                            ...
                                                                                                                            <span
                                                                                                                                class="t47"
                                                                                                                                style="display:block;margin:0;Margin:0;font-family:Open Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:20px;font-weight:600;font-style:normal;font-size:14px;text-decoration:none;direction:ltr;color:#222222;text-align:center;mso-line-height-rule:exactly;mso-text-raise:2px;">
                                                                                                                                {{ $company }}
                                                                                                                            </span>
                                                                                                                        </td>
                                                                                                                    </tr>
