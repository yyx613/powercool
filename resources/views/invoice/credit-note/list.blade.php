                ...
                { 
                    ...
                    render: function (data, type, row) {
                        return  `<div class="flex items-center justify-end gap-x-2 px-2">
                            <a href="{{ config('app.url') }}/e-invoice/download?uuid=${row.uuid}&type=credit" class="rounded-full p-2 bg-green-200 inline-block" target="_blank">
                            ...
                            <button class="send-to-customer-btn rounded-full p-2 bg-green-200 inline-block"
                                data-id="${row.id}" data-type="credit">
