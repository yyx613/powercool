...
@section('content')
    <div class="mb-6">
        <x-app.page-title url="{{ route('invoice.e-invoice.index') }}">{{ __('Submit Credit/Debit Note') }}</x-app.page-title>
    </div>
    <div class="bg-white p-4 border rounded-md flex gap-x-14">
        ...
        <div class="flex flex-col gap-y-6 flex-1">
            <div class="flex items-center bg-yellow-100 rounded overflow-hidden {{ $step != 1 ? 'opacity-25' : ''  }}">
                <h6 class="font-semibold mx-4 p-2">{{ __('From Selection') }}</h6>
            </div>
            <div class="flex items-center bg-yellow-100 rounded overflow-hidden {{ $step != 2 ? 'opacity-25' : ''  }}">
                ...
                <h6 class="font-semibold mx-4">{{ __('Company Selection') }}</h6>
            </div>
            <div class="flex items-center bg-yellow-100 rounded overflow-hidden {{ $step != 3 ? 'opacity-25' : ''  }}">
                ...
                <h6 class="font-semibold mx-4">{{ __('Note Type Selection') }}</h6>
            </div>
            <!-- Step 1 -->
            ...
            <div class="flex items-center bg-yellow-100 rounded overflow-hidden {{ $step != 5 ? 'opacity-25' : ''  }}">
                ...
                <h6 class="font-semibold mx-4">{{ __('E Invoice Selection') }}</h6>
            </div>
            <div class="flex items-center bg-yellow-100 rounded overflow-hidden {{ $step != 6 ? 'opacity-25' : ''  }}">
                ...
                <h6 class="font-semibold mx-4">{{ __('Update E Invoice') }}</h6>
            </div>
        </div>
        <!-- Steps Content -->
        <div class="flex-[3]">
            ...
            @if ($step == 1)
                <div>
                    <div class="mb-2">
                        <h5 class="text-md font-semibold">{{ __('Select from to proceed') }}</h5>
                    </div>
                    <ul>
            ...
            @if ($step == 2)
                <div>
                    <div class="mb-2">
                        <h5 class="text-md font-semibold">{{ __('Select a company to proceed') }}</h5>
                    </div>
                    <ul>
                        <li class="mb-4 rounded-md cursor-pointer transition duration-300 border border-slate-100 hover:border-black customer-selections" >
            ...
            @if ($step == 3)
                <div>
                    <div class="mb-2">
                        <h5 class="text-md font-semibold">{{ __('Select Credit or Debit Note to proceed') }}</h5>
                    </div>
                    <ul>
                        <li class="mb-4 rounded-md cursor-pointer transition duration-300 border border-slate-100 hover:border-black customer-selections" >
            ...
            @if ($step == 5)
                <div>
                    <div class="mb-2">
                        <h5 class="text-md font-semibold">{{ __('Select e-invoices to proceed') }}</h5>
                    </div>
                    <div class="mb-4">
            ...
            @if ($step == 6)
                <div>
                    <div class="mb-2">
                        <h5 class="text-md font-semibold">{{ __('Update Invoice Data to proceed') }}</h5>
                    </div>
                        ...
                        <form action="{{ route('submit.note') }}" method="POST" id="main-form">
                                        ...
                                        <table class="text-sm rounded-lg overflow-hidden w-full mt-2">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td></td>
                                                    <td></td>
                                                    <td class="font-black pt-2">{{ __('Total') }}</td>
                            ...
                            <div class="flex justify-end mt-8">
                                <button type="submit" class="bg-slate-100 rounded-md py-2 px-4 flex justify-center items-center gap-x-2">
                                    ...
                                    <span class="text-sm font-semibold">{{ __('Submit All') }}</span>
                                </button>
                            </div>
