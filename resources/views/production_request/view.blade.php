...
@push('scripts')
    <script>
        ...
        var dt = new DataTable('#data-table', {
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    orderable: false,
                    render: function(data, type, row) {
                        const CAN_COMPLETE = @json(hasPermission('production_request.complete'));
        ...
        $('#production-request-complete-modal #yes-btn').on('click', function() {
            ...
            let productionId = $('#production-request-complete-modal select[name="production_id"]').val()
