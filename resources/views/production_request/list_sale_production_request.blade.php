                    ...
                    return `<div class="flex items-center justify-end gap-x-2 px-2">
                                ${
                                    row.has_material_use ? '' : `
                                        <a href="{{ config('app.url') }}/production-request/to-material-use/${row.id}/${row.product_id}" class="rounded-full p-2 bg-purple-200 inline-block" title="{!! __('To Production') !!}">
