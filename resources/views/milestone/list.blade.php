...
@section('content')
    <div class="mb-6 flex justify-between items-start md:items-center flex-col md:flex-row">
        <x-app.page-title class="mb-4 md:mb-0">{{ __('Milestone') }}</x-app.page-title>
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `<div class="flex items-center justify-end gap-x-2 px-2">
                            <a href="{{ config('app.url') }}/milestone/edit/${row.category_id}/${row.type_id}" class="rounded-full p-2 bg-blue-200 inline-block" title="{!! __('Edit') !!}">
