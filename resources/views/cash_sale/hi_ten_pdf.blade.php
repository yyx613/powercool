            ...
            <tr>
                <td colspan="2" style="padding: 0 35px 0 0;">
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        <tr>
                            <td style="font-size: 14px; padding: 5px 0 0 0;">TEL: {{ $sale->custom_mobile }}</td>
                            <td style="font-size: 14px; padding: 5px 0 0 0;">ATT: {{ $sale->custom_customer }}</td>
                        </tr>
                    </table>
                </td>
        ...
        <table style="width: 100%; font-family: sans-serif; border-collapse: collapse;">
            <tr>
                ...
                <td style="font-size: 10px; border-bottom: solid 1px black; padding: 0 4px 5px 4px; text-align: left;">
                    Description</td>
                <td
                    style="font-size: 10px; border-bottom: solid 1px black; padding: 0 4px 5px 4px; text-align: center; width: 5%;">
                    Qty</td>
                <td
                    style="font-size: 10px; border-bottom: solid 1px black; padding: 0 4px 5px 4px; text-align: center; width: 5%;">
                    FOC Qty</td>
            ...
            @foreach ($products as $key => $prod)
                <tr>
                    ...
                    <td
                        ...
                        {{ $prod->desc }}</td>
                    <td
                        style="vertical-align: start; font-size: 10px; text-align: center; padding: {{ $key == 0 ? '0' : '20px' }} 4px 0 4px;">
