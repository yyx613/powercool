...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        <x-app.page-title>{{ __('Material Use') }}</x-app.page-title>
        <a href="{{ route('material_use.create') }}" class="bg-yellow-400 shadow rounded-md py-2 px-4 flex items-center gap-x-2">
                ...
                { 
                    ...
                    render: function (data, type, row) {
                       return  `<div class="flex items-center justify-end gap-x-2 px-2">
                            <a href="{{ config('app.url') }}/material-use/edit/${row.id}" class="rounded-full p-2 bg-blue-200 inline-block">
