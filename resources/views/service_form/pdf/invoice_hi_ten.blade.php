        ...
        <table style="width: 100%; font-family: sans-serif; border-collapse: collapse; border-top: solid 1px black;">
            <tr>
                ...
                <td style="font-size: 12px; border-bottom: solid 1px black; padding: 0 4px 5px 4px; text-align: left;">
                    Description</td>
                <td
                    style="font-size: 12px; border-bottom: solid 1px black; padding: 0 4px 5px 4px; text-align: center; width: 5%;">
                    Qty</td>
                <td
                    style="font-size: 12px; border-bottom: solid 1px black; padding: 0 4px 5px 4px; text-align: center; width: 7%;">
                    FOC Qty</td>
                <td
                    style="font-size: 12px; border-bottom: solid 1px black; padding: 0 4px 5px 4px; text-align: right; width: 12%;">
                    U/Price (RM)</td>
                <td
            ...
            @foreach ($products as $key => $prod)
                ...
                <tr>
                    <td
                        ...
                        {{ $key + 1 }}</td>
                    <td
                        style="vertical-align: start; font-size: 12px; text-align: left; padding: {{ $key == 0 ? '5px' : '15px' }} 10px 0 4px;">
                        {{ $prod->getItemCode() }}</td>
                    <td
                        style="vertical-align: start; font-size: 12px; text-align: left; padding: {{ $key == 0 ? '5px' : '15px' }} 4px 0 4px;">
                        {{ $prod->getDescription() }}
                    ...
                    <td
                        style="vertical-align: start; font-size: 12px; text-align: center; padding: {{ $key == 0 ? '5px' : '15px' }} 4px 0 4px;">
                        {{ $displayQty }}</td>
                    <td
                        style="vertical-align: start; font-size: 12px; text-align: center; padding: {{ $key == 0 ? '5px' : '15px' }} 4px 0 4px;">
                        {{ $focQty }}</td>
