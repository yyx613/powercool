        ...
        <div class="bg-white p-4 rounded-md shadow" id="content-container">
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-8 w-full mb-4">
                ...
                <div class="flex flex-col">
                    ...
                    <x-app.input.input name="chasis" id="chasis" class="uppercase-input" :hasError="$errors->has('chasis')" value="{{ old('chasis', isset($vehicle) ? $vehicle->chasis : null) }}" />
                ...
                <div class="flex flex-col">
                    ...
                    <x-app.input.input name="buatan_nama_model" id="buatan_nama_model" class="uppercase-input" :hasError="$errors->has('buatan_nama_model')" value="{{ old('buatan_nama_model', isset($vehicle) ? $vehicle->buatan_nama_model : null) }}" />
                ...
                <div class="flex flex-col">
                    ...
                    <x-app.input.input name="keupayaan_enjin" id="keupayaan_enjin" class="uppercase-input" :hasError="$errors->has('keupayaan_enjin')" value="{{ old('keupayaan_enjin', isset($vehicle) ? $vehicle->keupayaan_enjin : null) }}" />
                ...
                <div class="flex flex-col">
                    ...
                    <x-app.input.input name="bahan_bakar" id="bahan_bakar" class="uppercase-input" :hasError="$errors->has('bahan_bakar')" value="{{ old('bahan_bakar', isset($vehicle) ? $vehicle->bahan_bakar : null) }}" />
                ...
                <div class="flex flex-col">
                    ...
                    <x-app.input.input name="status_asal" id="status_asal" class="uppercase-input" :hasError="$errors->has('status_asal')" value="{{ old('status_asal', isset($vehicle) ? $vehicle->status_asal : null) }}" />
                ...
                <div class="flex flex-col">
                    ...
                    <x-app.input.input name="kelas_kegunaan" id="kelas_kegunaan" class="uppercase-input" :hasError="$errors->has('kelas_kegunaan')" value="{{ old('kelas_kegunaan', isset($vehicle) ? $vehicle->kelas_kegunaan : null) }}" />
                ...
                <div class="flex flex-col">
                    ...
                    <x-app.input.input name="jenis_badan" id="jenis_badan" class="uppercase-input" :hasError="$errors->has('jenis_badan')" value="{{ old('jenis_badan', isset($vehicle) ? $vehicle->jenis_badan : null) }}" />
