<x-app.modal.base-modal id="delete-modal">
    <div class="aspect-[2/1] flex flex-col">
        <div class="border-b py-2 px-4 bg-gray-100">
            <h6 class="text-lg font-black" id="title">Delete Confirmation</h6>
        </div>
        <div class="flex-1 flex flex-col p-4">
            <div class="flex-1">
                <p class="text-slate-500 leading-snug">Are you sure to delete the record?</p>
            </div>
            <div class="flex gap-x-6">
                ...
                <div class="flex-1 flex">
                    <a href="" class="w-full p-2 rounded-md bg-blue-600 text-white text-sm font-medium transiton-all duration-300 text-center hover:bg-blue-700" id="yes-btn">Yes</a>
                </div>
            </div>
        </div>
    </div>
