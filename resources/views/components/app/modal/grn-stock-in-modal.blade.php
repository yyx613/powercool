<x-app.modal.base-modal id="stock-in-modal">
    <div class="aspect-[2/1] flex flex-col">
        <form action="{{ route('grn.stock_in') }}" method="POST">
            ...
            <div class="border-b py-2 px-4 bg-purple-100 flex items-center">
                ...
                <h6 class="text-lg font-black ml-3">Stock In</h6>
            </div>
            <div class="flex-1 flex flex-col p-4">
                    ...
                    @foreach($grns as $grn) 
                        <div class="mb-4">
                            <div class="mb-0.5 flex items-center justify-between">
                                ...
                                <span class="text-xs">Stock In UOM: {{ $grn->product->uom ?? '-' }}</span>
                            </div>
                            <div>
                ...
                <div class="flex gap-x-6">
                    ...
                    <div class="flex-1 flex">
                        <button type="submit" class="w-full p-2 rounded-md bg-blue-600 text-white text-sm font-medium transiton-all duration-300 text-center hover:bg-blue-700" id="yes-btn">Confirm</button>
                    </div>
                </div>
            </div>
        </form>
