<x-app.modal.base-modal id="transfer-modal">
    <div class="aspect-[2/1] flex flex-col">
        <div class="border-b py-2 px-4 bg-emerald-100 flex items-center">
            ...
            <h6 class="text-lg font-black ml-3">Transfer</h6>
        </div>
        <div class="flex-1 flex flex-col p-4">
            <div class="mb-8">
                ...
                <div>
                    <span class="font-medium text-sm mb-1 block">Branch to Transfer</span>
            ...
            <div class="flex gap-x-6">
                ...
                <div class="flex-1 flex">
                    <a href="" class="w-full p-2 rounded-md bg-blue-600 text-white text-sm font-medium transiton-all duration-300 text-center hover:bg-blue-700" id="yes-btn">Confirm</a>
                </div>
            </div>
        </div>
    </div>
