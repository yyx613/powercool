<x-app.modal.base-modal id="customer-sync-modal">
    <div class="aspect-[2/1] flex flex-col">
        ...
        <div class="flex-1 flex flex-col p-4">
            <div class="flex-1">
                <p class="text-slate-500 leading-snug">{{ __('Are you want to sync this customer?') }}</p>
            </div>
...
@push('scripts')
<script>
    $('#customer-sync-modal #no-btn').on('click', function() {
        $('#customer-sync-modal').removeClass('show-modal')
    })
</script>
@endpush