...
@section('content')
    <div class="mb-3 flex justify-between items-start md:items-center flex-col md:flex-row">
        <x-app.page-title class="mb-2 md:mb-0" description="{{ __('Download billing documents and submit e-invoices in bulk') }}">{{ __('Billing') }}</x-app.page-title><div class="flex flex-wrap gap-2">
