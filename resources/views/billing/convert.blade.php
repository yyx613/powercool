                                        ...
                                        <div class="w-full p-3 rounded-md border border-slate-200">
                                            ...
                                            <div class="border-t pt-4 mt-4">
                                                ...
                                                <div class="item-row-template items flex items-center gap-4 hidden" data-product-id="{{ $pro->product->id }}">
                                                    <x-app.input.input name="qty_{{ $pro->product->id }}[]" placeholder="{{ __('Enter quantity') }}" class="int-input text-sm flex-1" />
                                                    <x-app.input.input name="price_{{ $pro->product->id }}[]" placeholder="{{ __('Enter price') }}" class="decimal-input text-sm flex-1" />
