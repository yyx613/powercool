        ...
        <div class="bg-white p-4 border rounded-md">
            <div class="max-h-44 overflow-y-auto">
                <table>
                    <thead>
                        <tr>
                            <th class="px-2 py-1 text-sm border-b">{{ __('Product') }}</th>
                            <th class="px-2 py-1 text-sm border-b">{{ __('Qty/SKU') }}</th>
                            <th class="px-2 py-1 text-sm border-b">{{ __('U/Price') }}</th>
                            <th class="px-2 py-1 text-sm border-b">{{ __('T/Price') }}</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($costs as $co)
