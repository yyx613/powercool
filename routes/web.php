...
Route::middleware('auth', 'select_lang', 'notification', 'approval')->group(function () {
    ...
    Route::controller(InventoryController::class)->prefix('inventory-summary')->name('inventory_summary.')->middleware(['can:inventory.summary.view'])->group(function () { // Inventory Category
        ...
        Route::get('/get-data', 'getData')->name('get_data');
        Route::get('/get-data-summary', 'getDataSummaryV2')->name('get_data_summary');
        Route::get('/get-remaining-qty', 'getRemainingQty')->name('get_remaining_qty');
        Route::get('/download-photo/{attachment}', 'downloadProductPhoto')->name('download_photo');
    });
    ...
    Route::controller(SaleController::class)->group(function () {
        ...
        Route::prefix('quotation')->name('quotation.')->middleware(['can:sale.quotation.view'])->group(function () {
            ...
            Route::post('/convert-to-sale-order', 'converToSaleOrder')->name('convert_to_sale_order');
        ...
        Route::prefix('sale-order')->name('sale_order.')->middleware(['can:sale.sale_order.view'])->group(function () {
            ...
            Route::get('/edit/payment/{sale}', 'editSaleOrder')->name('edit_payment')->middleware(['can:sale.sale_order.payment']);
    ...
    Route::controller(ReportController::class)->prefix('report')->name('report.')->group(function () {
        Route::prefix('production-report')->name('production_report.')->middleware(['can:report.production'])->group(function () {
        ...
        Route::prefix('sales-report')->name('sales_report.')->middleware(['can:report.sales'])->group(function () {
        ...
        Route::prefix('stock-report')->name('stock_report.')->middleware(['can:report.stock'])->group(function () {
        ...
        Route::prefix('earning-report')->name('earning_report.')->middleware(['can:report.earning'])->group(function () {
        ...
        Route::prefix('service-report')->name('service_report.')->middleware(['can:report.service'])->group(function () {
        ...
        Route::prefix('technician-stock-report')->name('technician_stock_report.')->middleware(['can:report.technician_stock'])->group(function () {
    ...
    // Setting - Material Use
    Route::middleware(['can:setting.material_use.view'])->group(function () {
    ...
    // Setting - Sync
    Route::middleware(['can:setting.sync.view'])->group(function () {
        Route::controller(SyncController::class)->prefix('sync')->name('sync.')->group(function () {
            Route::get('/', 'index')->name('index');
        });
    });
    // Setting - Warranty Period
    Route::middleware(['can:setting.warranty_period.view'])->group(function () {
    ...
    // Setting - Promotion
    Route::middleware(['can:setting.promotion.view'])->group(function () {
    ...
    Route::middleware(['can:setting.project_type.view'])->group(function () {
    ...
    // Setting - Currency
    Route::middleware(['can:setting.currency.view'])->group(function () {
    ...
    // Setting - Credit Term
    Route::middleware(['can:setting.credit_term.view'])->group(function () {
    ...
    Route::middleware(['can:setting.payment_method.view'])->group(function () {
    ...
    // Setting - City
    Route::middleware(['can:setting.area.view'])->group(function () {
    ...
    // Setting - Country
    Route::middleware(['can:setting.country.view'])->group(function () {
    ...
    // Setting - Debtor Type
    Route::middleware(['can:setting.debtor_type.view'])->group(function () {
    ...
    // Setting - Factory
    Route::middleware(['can:setting.factory.view'])->group(function () {
    ...
    // Setting - Milestone
    Route::middleware(['can:setting.milestone.view'])->group(function () {
    ...
    // Setting - UOM
    Route::middleware(['can:setting.uom.view'])->group(function () {
    ...
    // Setting - Platform
    Route::middleware(['can:setting.platform.view'])->group(function () {
    ...
    // Setting - Priorities
    Route::middleware(['can:setting.priority.view'])->group(function () {
    ...
    // Setting - Sales Agent
    Route::middleware(['can:setting.sales_agent.view'])->group(function () {
    ...
    // Setting - Tax Rate
    Route::middleware(['can:setting.tax_rate.view'])->group(function () {
        Route::controller(SettingController::class)->prefix('settings')->name('setting.')->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('/get-data', 'getData')->name('get_data');
            Route::get('/edit/{setting}', 'edit')->name('edit')->middleware(['can:setting.tax_rate.view']);
            Route::post('/update/{setting}', 'update')->name('update')->middleware(['can:setting.tax_rate.view']);
        });
    });
